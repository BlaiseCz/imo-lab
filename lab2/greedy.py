...
def greedy_nodes(path, distance_matrix, swap=2):
    better_solution = True
    better_solution_found = False
    best_path = deepcopy(path)
    buff_path = deepcopy(path)
    ...
    while better_solution:
        ...
        buff_path[node_to_switch[0]], buff_path[node_to_switch[1]] = buff_path[node_to_switch[1]], buff_path[node_to_switch[0]]
        updated_dist = calculate_distance(distance_matrix, buff_path)
